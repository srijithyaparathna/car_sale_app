...
$(document).ready(function () {
  ...
  rangeSlider.noUiSlider.on('update', function (values, handle) {
    ...
    document.getElementById('min-value1').value = moneyFormat.from(
      values[0]);
    document.getElementById('max-value1').value = moneyFormat.from(
      values[1]);
  });
});
...
$(document).ready(function () {
  ...
  rangeSlider.noUiSlider.on('update', function (values, handle) {
    ...
    document.getElementById('min-value2').value = moneyFormat.from(
      values[0]);
    document.getElementById('max-value2').value = moneyFormat.from(
      values[1]);
  });
});
$(document).ready(function () {
  ...
  rangeSlider.noUiSlider.on('update', function (values, handle) {
    ...
    document.getElementById('min-value3').value = moneyFormat.from(
      values[0]);
    document.getElementById('max-value3').value = moneyFormat.from(
      values[1]);
  });
});
