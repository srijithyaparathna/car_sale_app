                            ...
                            <div class="wrap-property-car flex">
                                <div class="box-1">
                                    <div class="icon-box-info flex">
                                        ...
                                        <div class="info flex">
                                            <span>Make: </span>
                                            <span class="fw-4"><?= isset($maincategory['category_name']) ? esc($maincategory['category_name']) : 'null'; ?></span>
                                        </div>
                                        <div class="info flex">
                                            <span>Model: </span>
                                            <span class="fw-4"><?= isset($subCategory['model_name']) ? esc($subCategory['model_name']) : 'null'; ?></span>
                                        </div>
                            ...
                            <div class="gallary-property-details">
                                        ...
                                        <?php foreach ($indexedImages as $index => $image) : ?>
                                            <?php if (!empty($image)) : ?>
                                                <div class="swiper-slide">
                                                    <div>
                                                        <img src="<?php echo esc(base_url($image)); ?>" alt="Car Image <?php echo $index + 1; ?>">
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                ...
                                <div class="swiper property-gallary">
                                    <div class="swiper-wrapper">
                                        ...
                                        <?php if (!empty($indexedImages[1])) : ?>
                                            <div class="swiper-slide">

                                                <div>
                                                    <img src="<?php echo esc(base_url($indexedImages[1])); ?>" alt="Car Image 1">
                                                </div>
                                        ...
                                        <?php if (!empty($indexedImages[2])) : ?>
                                            <div class="swiper-slide">

                                                <div>
                                                    <img src="<?php echo esc(base_url($indexedImages[2])); ?>" alt="Car Image 1">
                                                </div>
                                        ...
                                        <div class="swiper-slide">
                                            <?php if (!empty($indexedImages[3])) : ?>
                                                <div>
                                                    <img src="<?php echo esc(base_url($indexedImages[3])); ?>" alt="Car Image 1">
                                                </div>
                                        ...
                                        <div class="swiper-slide">
                                            <?php if (!empty($indexedImages[4])) : ?>
                                                <div>
                                                    <img src="<?php echo esc(base_url($indexedImages[4])); ?>" alt="Car Image 1">
                                                </div>
                                        ...
                                        <div class="swiper-slide">
                                            <?php if (!empty($indexedImages[5])) : ?>
                                                <div>
                                                    <img src="<?php echo esc(base_url($indexedImages[5])); ?>" alt="Car Image 1">
                                                </div>

                                            <?php endif; ?>
                                        </div>
                                        <div class="swiper-slide">
                                            <?php if (!empty($indexedImages[6])) : ?>
                                                <div>
                                                    <img src="<?php echo esc(base_url($indexedImages[6])); ?>" alt="Car Image 1">
                                                </div>

                                            <?php endif; ?>
                                        </div>

                                        <?php if (!empty($indexedImages[7])) : ?>
                                            <div class="swiper-slide">

                                                <div>
                                                    <img src="<?php echo esc(base_url($indexedImages[7])); ?>" alt="Car Image 1">
                                                </div>
                                            ...
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        ...
                                                        <p class="listing-info-value"><?= esc($car['condition']) ?: 'N/A'; ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        ...
                                                        <p class="listing-info-value"><?= esc($car['cylinders']) ?: 'N/A'; ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 item">
                                            ...
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        ...
                                                        <p class="listing-info-value"><?= esc($car['fuel_type']) ?: 'N/A'; ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 item">
                                            ...
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        ...
                                                        <p class="listing-info-value"> <?= esc($car['doors']) ?: 'N/A'; ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        ...
                                                        <p class="listing-info-value"><?= esc($car['year']) ?: 'N/A'; ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        ...
                                                        <p class="listing-info-value"><?= esc($car['color']) ?: 'N/A'; ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 item">
                                            ...
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        ...
                                                        <p class="listing-info-value"><?= esc($car['seats']) ?: 'N/A'; ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        ...
                                                        <p class="listing-info-value"><?= esc($car['transmission']) ?: 'N/A'; ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        ...
                                                        <p class="listing-info-value"><?= esc($car['city_mpg']) ?: 'N/A'; ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        ...
                                                        <p class="listing-info-value"><?= esc($car['engine_size']) ?: 'N/A'; ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        ...
                                                        <p class="listing-info-value"><?= esc($car['highway_mpg']) ?: 'N/A'; ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        ...
                                                        <p class="listing-info-value"><?= esc($car['driver_type']) ?: 'N/A'; ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="author-contact-listing-wrap">
                                <div class="author-contact-wrap">
                                    <div class="author-contact-avatar">
                                        <img src="<?= base_url('./assets/images/avatar/avt-admin.png') ?>" title="image">
                                    </div>
                                ...
                                <form action="/inquiry/create/<?= esc($car['id']) ?>" method="post" class="form-contact-admin" aria-label="Contact form" type="form-data"  >
                                    <div class="group-form">
                                        <input class="admin-form" aria-required="true" aria-invalid="false" name="customer_name" placeholder="Your Name" value="" type="text" required>
                                        <i class="icon-user-1-1"></i>
                                    </div>
                                    <div class="group-form">
                                        <input class="admin-form" aria-required="true" aria-invalid="false" name="customer_email" placeholder="Email" value="" type="email" required>
                                        <i class="icon-Group2"></i>
                                    </div>
                                    <div class="group-form">
                                        <input class="admin-form" aria-invalid="false" name="customer_mobile" placeholder="Enter Phone" value="" type="text" required>
                                        <i class="icon-Group-14"></i>
                                    </div>
                                    <div class="group-form">
                                        <textarea class="admin-form" aria-invalid="false" name="customer_message" required></textarea>
                                        <i class="icon-edit-1"></i>
                                    </div>

                                    <form id="messageForm" >
                                    
                                    <button  onclick="submitForms()" > Send Message </button>
                                    </form>
                                </form>
<script>
  ...
  window.addEventListener('load', function() {
    ...
    window.submitForms = function() {
      ...
      setTimeout(function() {
        document.querySelector('.preload-container-car').style.display = 'none';
      }, 5000);
        ...
        <div class="modal  fade" id="test-driver" aria-hidden="true" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="/" method="post" class="test-driver-form" aria-label="Contact form" novalidate="novalidate" data-status="init">
                        <div class="group-form">
