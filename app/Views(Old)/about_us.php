...
<head>
    ...
    <title>RNR Auto World | About Us</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                        <div class="sub-banner_aboutus_content" data-aos="fade-right">
                            ...
                            <h2>WELCOME TO THE MOTOR<span class="text-red">X</span></h2>
                            <p class="margin_bottom">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam a facilisis magna.
                                Ut eu interdum justo. In vestibulum purus vel tincidunt rhoncus. Phasellus id congue arcu.
                            </p>
                            <p>Vestibulum eu lectus nisl. Quisque accumsan neque vel tincidunt ullamcorper.
                                Aliquam porttitor sed risus nec eleifend.</p>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="box_wrapper">
                                        ...
                                        <p class="mb-0 text-red text-black-50">TEMPORE CUM SOLUTA NOBIS ESTLIGENDI OPTIO CUMQUE NIHIL IMPEDIT.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="feature-v2-car-wrap">
                    <div class="header-section">
                        <div class="heading-section">
                            <span class="sub-title mb-6 wow fadeInUp">20% OFF FOR ONLINE BOOKing</span>
                    ...
                    <div class="icon-box-feature">
                        <div class="icon-box-item">
                            ...
                            <div class="content">
                                ...
                                <p class="description">Lorem ipsum dolor sit amet, consect adipiscing elit.</p>
                            </div>
                        </div>
                        <div class="icon-box-item">
                            <div class="image">
