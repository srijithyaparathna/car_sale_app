                    ...
                    <div class="tf-widget-add-cart">
                        <div class="themesflat-container">
                            <div class="tf-add-cart">
                                ...
                                <form action="/add_car_2" method="post" id="submit-add-form" class="form-add-cart needs-validation" enctype="multipart/form-data">
                                        ...
                                        <div class="listing-fields-grid mb-30">
                                            <div class="form-group">
                                                ...
                                                <div class="group-select">
                                                    <select name="main-category" id="main-category" class="form-control nice-select" required>
                                            ...
                                            <div class="form-group">
                                                <label>Model</label>
                                                <div class="group-select">
                                                    <select name="sub-category" id="sub-category" class="form-control nice-select" required >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="group-select">
                                                    ...
                                                    <select name="condition" id="condition" class="form-control nice-select" required >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="group-select">
                                                    ...
                                                    <select name="transmission" id="transmission" class="form-control nice-select " required >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="group-select">
                                                    <select name="driver_type" id="driver_type" class="form-control nice-select " required >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="group-select">
                                                    <select name="cylinders" id="cylinders" class="form-control nice-select" required >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="group-select">
                                                    <select name="fuel_type" id="fuel_type" class="form-control nice-select" required >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="group-select">
                                                    <select name="doors" id="doors" class="form-control nice-select" required >
                                                        <option value="4">4</option>
                                                        <option value="2">2</option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="group-select">
                                                    <select name="color" id="color" class="form-control nice-select" required >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="group-select">
                                                    <select name="seats" id="seats" class="form-control nice-select" required >
                                                        <option value="1">1</option>
                                                        <option value="2">2</option>
                                                        <option value="3">3</option>
                                                        <option value="4">4</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="group-select">
                                                    <input type="number" id="city_mpg" name="city_mpg" required placeholder="City MPG" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label>Highway MPG</label>
                                                <div class="group-select">
                                                    <input type="number" id="highway_mpg" name="highway_mpg" required placeholder="Highway MPG" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="listing-fields-grid mb-30">
                                            <div class="form-group">
                                                ...
                                                <div class="group-select">
                                                    ...
                                                    <select name="price_type" id="price_type" class="form-control nice-select" required>
                                        ...
                                        <div class="upload-image-add-car">
                                            <div class="upload-image">
                                                <label for="photoLoad1" class="uploadLabel">
                                                    ...
                                                    <input type="file" id="photoLoad1" name="images[]" class="photoLoad" accept="image/*" onchange="checkImageSize(this, 'uploadedImage1')" required>
                                            ...
                                            <div class="upload-image">
                                                <label for="photoLoad2" class="uploadLabel">
                                                    ...
                                                    <span>Add a Photo</span>
                                                    <input type="file" id="photoLoad2" name="images[]" class="photoLoad" accept="image/*" onchange="checkImageSize(this, 'uploadedImage2')" required >
                                            ...
                                            <div class="upload-image">
                                                <label for="photoLoad3" class="uploadLabel">
                                                    ...
                                                    <span>Add a Photo</span>
                                                    <input type="file" id="photoLoad3" name="images[]" class="photoLoad" accept="image/*" onchange="checkImageSize(this, 'uploadedImage3')">
                                            ...
                                            <div class="upload-image">
                                                <label for="photoLoad4" class="uploadLabel">
                                                    ...
                                                    <span>Add a Photo</span>
                                                    <input type="file" id="photoLoad4" name="images[]" class="photoLoad" accept="image/*" onchange="checkImageSize(this, 'uploadedImage4')">
                                            ...
                                            <div class="upload-image">
                                                <label for="photoLoad5" class="uploadLabel">
                                                    ...
                                                    <span>Add a Photo</span>
                                                    <input type="file" id="photoLoad5" name="images[]" class="photoLoad" accept="image/*" onchange="checkImageSize(this, 'uploadedImage5')">
                                            ...
                                            <div class="upload-image">
                                                <label for="photoLoad6" class="uploadLabel">
                                                    ...
                                                    <span>Add a Photo</span>
                                                    <input type="file" id="photoLoad6" name="images[]" class="photoLoad" accept="image/*" onchange="checkImageSize(this, 'uploadedImage6')">
                                            ...
                                            <div class="upload-image">
                                                <label for="photoLoad7" class="uploadLabel">
                                                    ...
                                                    <span>Add a Photo</span>
                                                    <input type="file" id="photoLoad7" name="images[]" class="photoLoad" accept="image/*" onchange="checkImageSize(this, 'uploadedImage7')">
                                    ...
                                    <fieldset id="video" class="pd-bg">
                                        ...
                                        <div class="form-group">
                                            <div class="group-video">
                                                <input type="text" id="img_url" name="img_url" placeholder="Enter YouTube URL"  pattern="[Hh][Tt][Tt][Pp][Ss]?:\/\/(?:(?:[a-zA-Z\u00a1-\uffff0-9]+-?)*[a-zA-Z\u00a1-\uffff0-9]+)(?:\.(?:[a-zA-Z\u00a1-\uffff0-9]+-?)*[a-zA-Z\u00a1-\uffff0-9]+)*(?:\.(?:[a-zA-Z\u00a1-\uffff]{2,}))(?::\d{2,5})?(?:\/[^\s]*)?" required>
                                    ...
                                    <fieldset id="file-attachment" class="pd-bg">
                                        ...
                                        <div class="upload-image">
                                            <label for="photoLoad5" class="uploadLabel">
                                                ...
                                                <span>Add a Photo</span>
                                                <input type="file" id="photoLoad5" name="images[]" class="photoLoad" accept="image/*" required>
                                ...
                                <div id="divLoader" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.5); z-index: -999; opacity: 0; transition: opacity 0.5s;">
