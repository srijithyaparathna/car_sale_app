                        ...
                        <form id="form1" action="/admin/edit-car/<?= $car['id'] ?>" method="put" id="submit-add-cart" class="form-add-cart needs-validation" novalidate>
                            ...
                            <fieldset id="information" class="mb-60">
                                <div class="inner-title mb-30">
                                    <span class="sub-title">Edit Your Vehicle</span>
                                    <h3 class="title">Edit Your Vehicle</h3>
                                   <!-- <h4> <?= htmlspecialchars($car['permalink']) ?> </h4> -->
                                </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="group-select">
                                            <input type="tel" id="permalink" name="permalink" placeholder="Enter VIN" value="<?= $car['permalink'] ?>" readonly >
                                        </div>
                                    </div>
                               ...
                               <div class="listing-fields-grid mb-30">
                                   ...
                                   <div class="form-group">
                                       ...
                                       <div class="group-select">
                                           <input type="text" id="main_vehicle_type" class="form-control" name="main_vehicle_type" value="<?= $car['main_vehicle_type'] ?>" readonly>
                                       </div>
                                   </div>
                                   <div class="form-group" id="sub-category-group">
                                       <label>Sub Category</label>
                                       <div class="group-select">
                                           <input type="text" id="sub_vehicle_type" class="form-control" name="sub_vehicle_type" value="<?= $car['sub_vehicle_type'] ?>" readonly>
                                       </div>
                                   </div>

                                   <script>
                                       window.onload = function () {
                                           const subVehicleType = document.getElementById('sub_vehicle_type').value;
                                   ...
                                   <div class="form-group">
                                       ...
                                       <div class="group-select">
                                           <input type="text" id="type" class="form-control" name="type" value="<?= $car['type'] ?>" readonly>
                                       </div>
                                   </div>
                               </div>
                                ...
                                <div class="listing-fields-grid mb-30">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="group-select">
                                            <input type="tel" id="vin_number" name="vin_number" placeholder="Enter VIN" value="<?= $car['vin_number'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Mileage</label>
                                        <div class="group-select">
                                            <input type="number" id="mileage" name="mileage" placeholder="Enter Mileage" value="<?= $car['mileage'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="group-select">
                                            <input type="text" id="engine_size" name="engine_size" placeholder="Enter Engine" value="<?= $car['engine_size'] ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="group-select">
                                        <input type="number" id="cylinders" name="cylinders" value="<?= $car['cylinders'] ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="group-select">
                                        <input type="number" id="doors" name="doors" value="<?= $car['doors'] ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="group-select">
                                            <input type="number" id="seats" name="seats" value="<?= $car['seats'] ?>"
                                                        placeholder="Enter Seats Count" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>City MPG</label>
                                        <div class="group-select">
                                        <input type="number" id="city_mpg" name="city_mpg" value="<?= $car['city_mpg'] ?>" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Highway MPG</label>
                                        <div class="group-select">
                                        <input type="number" id="highway_mpg" name="highway_mpg" value="<?= $car['highway_mpg'] ?>" >
                                        </div>
                                    </div>
                                </div>
...
<div class="description-fields mb-30">
                                        <div class="form-group">
                                            ...
                                            <div class="group-select">
                                                    <textarea id="metakeywords" name="metakeywords" class="form-control"
                                                              placeholder="MetaKeyWords" ><?= htmlspecialchars($car['metakeywords']) ?> </textarea>
                                            </div>
                                        </div>
                                    </div>           
                                    ...
                                    <div class="listing-fields-grid mb-30">
                                        <div class="form-group">
                                            ...
                                            <select name="price_type" id="price_type" class="form-control nice-select">
                                                ...
                                                <option value="Contact for price" <?= $car['price_type'] == 'Contact for price' ? 'selected' : '' ?>>Contact for Price</option>
                                            </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group" id="regular-price-group">
                                        ...
                                        <div class="group-select">
                                            <input type="number" id="regular_price" name="regular_price" placeholder="Enter Sale Price" value="<?= $car['regular_price'] ?>">
                                        </div>
                                    </div>
                                ...
                                <script>
                                    document.addEventListener('DOMContentLoaded', function() {
                                        ...
                                        priceType.addEventListener('change', togglePriceFields);
                                    });
...
<div class="listing-feature-item">
    ...
    $displayedImages = [];
    $maxSlots = 15; // Maximum number of slots to display
...
<!-- Add a submit button -->
    ...
    <div class="group-video">
        <input type="text" id="img_url" name="img_url" placeholder="Enter YouTube URL" 
        ...
        <div class="upload-image">
            <label for="photoLoad8" class="uploadLabel">
                ...
                <?php if ($documentImageUrl): // Check if the document image URL is set ?>
                    <img id="uploadedDocument" src="<?= $documentImageUrl ?>" alt=s"Uploaded Document" style="display: block;">
                    <input type="hidden" name="existing_document_id" value="<?= $documentImageId ?>">
                <?php else: ?>
                    <i class="icon-Group4"></i>
