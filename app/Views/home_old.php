                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <ul class="list-infor-topbar">
                                ...
                                <li>
                                    <a href="mailto:jeewantha30@yahoo.co.uk">
                                        <i class="icon-Group3"></i>
                                        <p>ruchini.shell@gmail.com</p>
                                    </a>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="tf-slide-item swiper-slide">
                    ...
                    <div class="slide-item-content">
                        ...
                        <div class="slide-image">
                            <!--<img src="<?= base_url('/assets/images/slide/icon.png'); ?>" loading="lazy" class="icon-shape wow swing" alt="">-->
                            <!--<div class="box-offer">
                                <p>40 <span>%</span></p>
                                <span>off</span>
                            </div>-->
                            <div class="box-car">
                                <img src="<?= base_url('assets/images/slide/car.png'); ?>" loading="lazy" alt="">
                            </div>
                        </div>
                        <div class="box">
