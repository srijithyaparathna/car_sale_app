...
<head>
    ...
    <title>R&R Auto World | About Us</title>
...
<div id="wrapper">
    <div id="page" class="clearfix">
                ...
                <div class="row">
                    <div class="col-lg-7 col-md-6 col-sm-12 col-xs-12">
                        <div class="sub-banner_aboutus_image">
                            <figure class="mb-0">
                                <img src="/assets/images/about/bl2.jpg" alt="" class="img-fluid">
                            </figure>
                        </div>
                    </div>
                    <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                        <div class="sub-banner_aboutus_content" data-aos="fade-right">
                            <h5 class="text-red">WELCOME TO THE</h5>
                            <h2><span class="text-red">R&R </span>AUTO WORLD</h2>
                            <p class="margin_bottom">R&R AutoRoute World is a trusted dealership offering a wide range of new and pre-owned vehicles. They focus on customer satisfaction and aim to provide hassle-free service. For over 15 years, they have set high standards in used car retailing with innovative and reliable programs.
                            </p>
                            <p>Their offerings include flexible pricing, expert car service, and special offers for online bookings. Located in South Ockendon</p>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="box_wrapper">
                                        <figure>
                                            <img src="./assets/images/about/aboutus_box_apostrophy.png" alt="" class="img-fluid apostrophy">
                                        </figure>
                                        <p class="mb-0 text-red text-black-50">At R&R auto world, we believe that all Vehicles these days require specialized services.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="counter-car">
                    <div class="counter-car-header-wrap">
                        <div class="counter-car-header">
                            ...
                            <h2 class="title wow fadeInUp">Leading the best Car Delers In UK</h2>
                        </div>
                        <div class="counter-car-content">
                            <p class="description wow fadeInUp">At R&R Auto World, we take pride in offering top-quality vehicles from trusted brands. 
                            Our extensive selection ensures you’ll find the perfect vehicle for your needs. 
                            Whether you're searching for a new or pre-owned vehicle, 
                            our dealership is committed to providing you with the best options and customer experience.
                            </p>
                        </div>
                    </div>
        ...
        <!-- About us Extra Features -->
        <div class="extra-features-container">
            <div class="themesflat-container">
                <div class="feature-v2-car-wrap">
                    <div class="header-section">
                        <div class="heading-section">
                            <span class="sub-title mb-6 wow fadeInUp">R&R AUTO WORLD</span>
                            <h2 class="title wow fadeInUp">Our Extra Features</h2>
                        </div>
                        <p class="description wow fadeInUp">For 15 years, we raising the standard of used car retailing with one
                            of the
                    ...
                    <div class="icon-box-feature">
                        <div class="icon-box-item">
                            ...
                            <div class="content">
                                <div class="title">Trusted Car Dealership</div>
                                <p class="description">At R&R Auto World, we pride ourselves on offering a seamless car buying experience with integrity and transparency.</p>
                            </div>
                        </div>
                        <div class="icon-box-item">
                            <div class="image">
                            ...
                            <div class="content">
                                <div class="title">Special Gift Offer</div>
                                <p class="description">Enjoy exclusive deals and special offers when you purchase your vehicle online, making your experience even more rewarding.</p>
                            </div>
                        </div>
                        <div class="icon-box-item">
                            <div class="image">
                            ...
                            <div class="content">
                                ...
                                <p class="description">We provide competitive pricing options that reasonably fit every budget, giving you the best value for your purchase.</p>
                            </div>
                        </div>
                        <div class="icon-box-item">
                            <div class="image">
                            ...
                            <div class="content">
                                <div class="title">Expert Car Service</div>
                                <p class="description">Our team of skilled technicians is committed to keeping your vehicle in top condition with professional maintenance and repair services.</p>
                            </div>
                        </div>
                    </div>
                </div>
